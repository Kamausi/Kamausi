  ...
  Object.assign(window.SkullToss.debug, {
    ...
    setInitials: ini => setInitials(ini), setFlags: v => Flags.set(v), flags: () => ({ ...Flags.values }), ensurePeriod: per => JSON.parse(JSON.stringify(ensurePeriod(per))), streakAfterRun: d => streakAfterRun(d),
