  ...
  const ACHIEVEMENTS = [
    ...
    { id: "crow-catcher",    name: "Crow Catcher",      text: "Beat the Crow King",                      stat: "miniKills", n: 1, bones: 150, icon: "crow" },
    { id: "pumpkin-smasher", name: "Pumpkin Smasher",   text: "Beat the Pumpkin King",                   stat: "bossKills", n: 1, bones: 300, icon: "pumpkin" },
    { id: "not-a-feather",   name: "Not a Feather Out of Place", text: "Beat the Crow King without a miss", stat: "miniFlawless", n: 1, bones: 250, icon: "crow" },
    { id: "clean-harvest",   name: "Clean Harvest",     text: "Beat the Pumpkin King without a miss",    stat: "bossFlawless", n: 1, bones: 400, icon: "pumpkin" },
    { id: "moving-on",       name: "Moving On",         text: "Reach stage 2",                           stat: "bestStage", n: 2, bones: 200, icon: "tomb" },
    { id: "grand-tour",      name: "Grand Tour",        text: "Reach stage 4",                           stat: "bestStage", n: 4, bones: 500, icon: "tomb" },
    { id: "whole-reel",      name: "The Whole Reel",    text: "Clear all four stages",                   stat: "bestStage", n: 5, bones: 1000, icon: "crown" },
    // arcade
